...
public class TesteFronteiraMenuEstoque {
	...
	@Test
	void testeCriarItemEstoqueComQuantidadeNaoInteira() throws CampoComValorInvalidoException {
		// Garante que o produto existe
		long idProduto = new ControladorProduto().criarProduto("Arroz", 2);
	...
	@Test
	void testeCriarItemEstoqueCorretamente() throws CampoComValorInvalidoException {
		// Garante que o produto existe
		long idProduto = new ControladorProduto().criarProduto("Arroz", 2);
